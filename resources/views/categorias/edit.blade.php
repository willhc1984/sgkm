...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4 border-light shadow">
        <div class="card-header space-between-elements">
            <span>Cadastrar</span>
            <span>
                <a href="{{ route('categoria.index') }}" class="btn btn-success btn-sm">
        ...
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('categoria.update', ['categoria' => $categoria->id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="col-12">
                    <label for="name" class="form-label">Nome:</label>
                    <input type="text" class="form-control" name="nome" id="nome" value="{{ old('nome', $categoria->nome) }}"
